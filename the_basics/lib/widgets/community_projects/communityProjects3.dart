...
class communityProjectCard3 extends StatefulWidget {

@override
_communityProjectCardState3 createState() => _communityProjectCardState3();
...
class _communityProjectCardState3  extends State<communityProjectCard3> {
bool _success = true;
...
child: Text(
"Assist people in managing finance"
,style: TextStyle(
fontSize: 13.0,
color: Colors.grey
),
