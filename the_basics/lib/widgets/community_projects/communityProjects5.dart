...
class communityProjectCard5 extends StatefulWidget {

  @override
  _communityProjectCardState5 createState() => _communityProjectCardState5();
...
class _communityProjectCardState5 extends State<communityProjectCard5> {
  bool _success = true;
            ...
            child: Column(
              children: [
                Stack(
                  children: [
                    Ink.image(
                      image: AssetImage('assets/final3.jpg'),
                      height: 240,
                      fit: BoxFit.cover,
                    ),
                  ],
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      "Network for environmental lovers"
                                      ,style: TextStyle(
                                        fontSize: 13.0,
                                        color: Colors.grey
                                    ),
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                              ...
                                              children: <Widget> [
                                                Container(
                                                    child: Text("Alan Lee", style: TextStyle(
                                                        color: Colors.black,
                                                        decoration: TextDecoration.underline))),
                                                Container(
                                                    child: Text("Submitted 5 mins ago", style: TextStyle(
