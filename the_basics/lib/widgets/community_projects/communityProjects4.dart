...
class communityProjectCard4 extends StatefulWidget {

  @override
  _communityProjectCardState4 createState() => _communityProjectCardState4();
...
class _communityProjectCardState4  extends State<communityProjectCard4> {
  bool _success = true;
            ...
            child: Column(
              children: [
                Stack(
                  children: [
                    Ink.image(
                      image: AssetImage('assets/final2.png'),
                      height: 240,
                      fit: BoxFit.cover,
                    ),
                  ],
